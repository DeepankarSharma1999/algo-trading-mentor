// A complete ValidationReport in the exact shapes engine/validation/pipeline.py writes, for tests
// and for populating a job row while the engine is down. Deterministic: no randomness.
import type { Stats, ValidationReport } from "@/lib/types";

const stats = (o: Partial<Stats>): Stats => ({
  trades: 0, wins: 0, losses: 0, win_rate: 0, expectancy_r: 0, avg_win_r: 0, avg_loss_r: 0, profit_factor: 0, net_pnl: 0,
...
const base = stats({ trades: 142, wins: 64, losses: 78, win_rate: 0.451, expectancy_r: 0.21, avg_win_r: 1.62, avg_loss_r: -0.93, profit_factor: 1.43, net_pnl: 59640, max_drawdown_pct: 7.8, max_drawdown_r: 15.6, largest_trade_share: 0.061, sharpe_ish: 0.17 });
const ins = stats({ trades: 104, wins: 48, losses: 56, win_rate: 0.462, expectancy_r: 0.24, avg_win_r: 1.6, avg_loss_r: -0.92, profit_factor: 1.49, net_pnl: 49920, max_drawdown_pct: 6.9, max_drawdown_r: 13.8, largest_trade_share: 0.07, sharpe_ish: 0.19 });
const oos = stats({ trades: 38, wins: 16, losses: 22, win_rate: 0.421, expectancy_r: 0.12, avg_win_r: 1.66, avg_loss_r: -0.95, profit_factor: 1.27, net_pnl: 9120, max_drawdown_pct: 5.4, max_drawdown_r: 10.8, largest_trade_share: 0.12, sharpe_ish: 0.1 });
